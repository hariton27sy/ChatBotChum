...
class BotLogicTests {
    ...
    @Test
    void analyzeAndGetAnswerRandomAnswer() throws ExecutionControl.NotImplementedException {
        UserInfo user = new UserInfo("Oleg");
        for(int i = 0; i < 100; i++) {
    ...
    @Test
    void formRequestAndGetAnswerTest() throws ExecutionControl.NotImplementedException {
        UserInfo user = new UserInfo("Oleg");
